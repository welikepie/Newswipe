...
(function (exports) {
    ...
    exports.Query = function (queryString) {
        ...
        var // parseQuery(q) parses the uri query string and returns a multi-dimensional array of the components
            ...
            // getParamValue(key) returns the first query param value found for the key 'key'
    ...
    exports.Uri = function (uriString) {
        ...
        var strictMode = false,
            ...
            queryObj = new exports.Query(uriParts.query),
            ...
            */
            ...
            clone = function () {
                return new exports.Uri(toString());
            };
...
}(typeof exports === 'object' && exports || jsUri));
