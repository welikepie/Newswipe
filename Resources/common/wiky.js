/**
 * exports.js - Javascript library to converts Wiki MarkUp language to HTML.
...
(function (exports) {
    ...
    exports.process = function(wikitext) {
        ...
        for (var i=0;i<lines.length;i++)
        {
            ...
            else if (line.match(/^:+/)!=null)
            {
                ...
                html += exports.process_indent(lines,start,i);
            }
            ...
            else if (line.match(/^(\*+) /)!=null)
            {
                ...
                html += exports.process_bullet_point(lines,start,i);
            }
            else if (line.match(/^(\#+) /)!=null)
            {
                // find start line and ending line
            ...
            {
                html += exports.process_normal(line);
            }
    ...
    exports.process_indent = function(lines,start,end) {
        var i = start;
        ...
        for(var i=start;i<=end;i++) {
            ...
            html += exports.process_normal(lines[i].substring(this_count));
            ...
            if (nested_end > i) {
                html += exports.process_indent(lines,i+1,nested_end);
                i = nested_end;
            }
    ...
    exports.process_bullet_point = function(lines,start,end) {
        var i = start;
        ...
        for(var i=start;i<=end;i++) {
            ...
            html += exports.process_normal(lines[i].substring(this_count+1));
                ...
                for (var j = i + 1; j <= end; j++) {
                    ...
                    if (nested_count < this_count) 
                        ...
                        if (lines[j].charAt(nested_count) == ':') {
                            html += "<br/>" + exports.process_normal(lines[j].substring(nested_count + 2));
                            nested_end = j;
                        } else {
                            break;
                        }
            ...
            // nested bullet point
            {
                ...
                if (nested_end > i) {
                    html += exports.process_bullet_point(lines, i + 1, nested_end);
                    i = nested_end;
                }
            }
            ...
            // continue previous with #:
            {
                ...
                for (var j = i + 1; j <= end; j++) {
                    ...
                    if (nested_count < this_count) 
                        ...
                        if (lines[j].charAt(nested_count) == ':') {
                            html += exports.process_normal(lines[j].substring(nested_count + 2));
                            nested_end = j;
                        } else {
                            break;
                        }
    ...
    exports.process_url = function(txt) {
    ...
    exports.process_image = function(txt) {
        var index = txt.indexOf(" ");
        url = txt;
        label = "";
    ...
    exports.process_video = function(url) {
    ...
    exports.process_normal = function(wikitext) {
        ...
        // Image
        {
            ...
            while (index > -1 && end_index > -1) {
                ...
                wikitext = wikitext.substring(0,index) 
                            + exports.process_image(wikitext.substring(index+7,end_index)) 
        ...
        // Video
        {
            ...
            while (index > -1 && end_index > -1) {
                ...
                wikitext = wikitext.substring(0,index) 
                            + exports.process_video(wikitext.substring(index+8,end_index)) 
                            + wikitext.substring(end_index+2);
        ...
        for (var i=0;i<protocols.length;i++)
        {
            ...
            while (index > -1 && end_index > -1) {
                ...
                wikitext = wikitext.substring(0,index) 
                            + exports.process_url(wikitext.substring(index+1,end_index)) 
...
}(typeof exports === 'object' && exports || wiky));